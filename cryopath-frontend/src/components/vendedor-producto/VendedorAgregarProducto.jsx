...
const VendedorAgregarProducto = ({ onNavigate }) => {
  ...
  const handleSubmit = (event) => {
    ...
    if (!Number.isFinite(cantidadDisponible) || cantidadDisponible < 1) {
      setErrorMessage("El inventario inicial debe ser un numero mayor o igual a 1.");
      setSubmitting(false);
      return;
    }
    ...
    const payload = {
      ...
      id_usuario: Number(userId) || userId,
    };
    ...
    crearProductoRequest(payload, token)
      .then(async (created) => {
        try {
          ...
          console.error("Error al subir las imagenes del producto:", error);
        }
              ...
              <label className="admin-form-field">
                ...
                >
                  ...
                  <p style={{ marginTop: "8px", fontSize: "0.9rem" }}>
                    Arrastra y suelta las imagenes o haz clic para seleccionarlas.
                  </p>
...
export default VendedorAgregarProducto;
